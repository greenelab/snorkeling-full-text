...
data_columns += train_generative_label_function_sampler(
    ...
    search_grid=grid,
    marginals_df_file=str(
        notebook_output_dir / Path("ctd_predicts_dag_training_marginals.tsv")
    ),
    curated_label="curated_dsh",
    entity_label="CtD",
    data_source="abstract",
...
data_columns += train_generative_label_function_sampler(
    ...
    search_grid=grid,
    marginals_df_file=str(
        notebook_output_dir / Path("cbg_predicts_dag_training_marginals.tsv")
    ),
    curated_label="curated_dsh",
    entity_label="CbG",
    data_source="abstract",
...
data_columns += train_generative_label_function_sampler(
    ...
    search_grid=grid,
    marginals_df_file=str(
        notebook_output_dir / Path("gig_predicts_dag_training_marginals.tsv")
    ),
    curated_label="curated_dsh",
    entity_label="GiG",
    data_source="abstract",
...
data_columns += train_generative_label_function_sampler(
    ...
    search_grid=grid,
    marginals_df_file=str(
        notebook_output_dir / Path("dag_predicts_dag_training_marginals_full_text.tsv")
    ),
    curated_label="curated_dsh",
    entity_label="DaG",
...
data_columns += train_generative_label_function_sampler(
    ...
    search_grid=grid,
    marginals_df_file=str(
        notebook_output_dir / Path("ctd_predicts_dag_training_marginals_full_text.tsv")
    ),
    curated_label="curated_dsh",
    entity_label="CtD",
    data_source="full_text",
...
data_columns += train_generative_label_function_sampler(
    ...
    search_grid=grid,
    marginals_df_file=str(
        notebook_output_dir / Path("cbg_predicts_dag_training_marginals_full_text.tsv")
    ),
    curated_label="curated_dsh",
    entity_label="CbG",
    data_source="full_text",
...
data_columns += train_generative_label_function_sampler(
    ...
    search_grid=grid,
    marginals_df_file=str(
        notebook_output_dir / Path("gig_predicts_dag_training_marginals_full_text.tsv")
    ),
    curated_label="curated_dsh",
    entity_label="GiG",
    data_source="full_text",
