...
# # Measure Compound treats Disease Edge Recall

# This notebook is designed to estimate how many hetionet edges can be recalled from this weakly supervised approach.
# After the discriminator model has been trained, the last step is to predict whether every candidate sentence is mentions a compound treats disease relationship.
