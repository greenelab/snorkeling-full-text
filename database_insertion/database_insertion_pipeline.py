...
# This step takes the longest time and requires heavy computation. Uses Spacy to parse sentences and writes features to individual files. Each file will contain every sentence parsed by spacy. Make sure you have enough disk space to run this section of the notebook. Current implementation (downloaded since March 2020) takes about half a terabyte (500GB)
